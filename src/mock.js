...
export const portfolioItems = [
  ...
  },
  {
    ...
    image: allImages["moso/_DSF3734.webp"],
  ...
  },
  {
    ...
    description: "Taze hamur işleri ve dengeli kahve aromasının buluştuğu Paqo’da sade lezzet anlayışı öne çıkar.",
    fullDescription: "Paqo Bakery & Coffee için; menü, e-ticaret ve sosyal medya platformlarında kullanılmak üzere özel bir konsept çekim gerçekleştirdik. Bu çalışma ile markanın taze fırın ürünlerini, tatlılarını ve kahve çeşitlerini modern, temiz ve iştah açıcı bir görsel dil ile öne çıkarmayı hedefledik",
  ...
  },
  {
    ...
    description: "Etin dokusunu ve lezzetini öne çıkaran net sunumuyla — güçlü bir görünüm sunar.",
    fullDescription: "Ercan Steakhouse için yapılan çekimlerde, etlerin dokusunu ve pişirme kalitesini vurgulayan sade ama etkili bir ışık düzeni kullanıldı. Amaç; sosyal medya platformlarında ürünü net, güçlü ve iştah açıcı bir şekilde öne çıkarmaktı. ",
  ...
  },
  {
    ...
    description: "Deniz manzarasıyla eşleşen taze mahsuller — Masmavi’de lezzet ve sadelik bir arada.",
    fullDescription: "Masmavi Balık Restaurant için yapılan çekimlerde, deniz ürünlerinin tazeliği ve mekânın sahil-ambiyansı sade bir ışık ve kompozisyonla öne çıkarıldı. Görseller dijital platformlarda markanın deniz kenarı kimliğini ve kaliteli sunum anlayışını net biçimde aktaracak şekilde kurgulandı.",
  ...
  },
  {
    ...
    description: "Doğal yetişmiş piliçler ve temiz kesim anlayışı — Beyza Piliç’te kalite ön planda.",
    fullDescription: "Beyza Piliç markası için yapılan çekimlerde, ürünlerin tazeliği ve işlenmiş haldeki temiz sunumu sade bir ışık ve minimal arka planla vurgulandı. Görseller dijital platformlarda markanın hijyen, güven ve profesyonellik eksenindeki kimliğini açık biçimde iletmek üzere tasarlandı.",
    client: "Beyza Piliç",
    year: "2024",
    role: "Yemek",
    gallery: [
  ...
  },
  {
    ...
    description: "Adana kebabı ve mezelerde iddialı sunum — Chef Erdal’de geleneğin tadı modern biçimde.",
    fullDescription: "Chef Erdal Adana Kebap markası için yapılan çekimlerde, etin ateşte pişmiş dokusu, meze çeşitlerinin renkleri ve mekânın samimi atmosferi dijital platformlara uygun net bir şekilde sunuldu. Görseller, markanın “otantik tat, şehirde erişilebilir” kimliğini sade ama etkili bir görsel dille destekleyecek şekilde tasarlandı.",
  ...
  },
  {
    ...
    description: "Izgara tatların buluştuğu mekânda — Barbisos’ta lezzet her zaman merkezde.",
    fullDescription: "Barbisos için yapılan fotoğraf çalışmasında, mangal ızgarasında pişmiş etlerin dokusu, patlıcanlı kebapların kömür ve duman atmosferi sade ama güçlü bir ışık düzeniyle sunuldu. Görseller, sosyal medya platformlarında markanın “anlık lezzet deneyimi” vurgusunu net şekilde iletecek şekilde oluşturuldu.",
    client: "Barbisos",
    year: "2024",
    role: "Yemek",
    gallery: [
  ...
  },
  {
    ...
    category: "Diğer",
    title: "Event",
    image: allImages["event/event10.webp"],
    description: "Canlı anların, doğal atmosferin ve etkinlik enerjisinin sade bir dille aktarıldığı bir çekim.",
    fullDescription: "Etkinlik için hazırlanan fotoğraf çalışmasında, mekânın ambiyansı, katılımcıların doğal etkileşimleri ve etkinliğin akışını oluşturan detaylar sade bir görsel dille belirlendi.",
    client: "Event",
    year: "2024",
    role: "Event",
    gallery: [
        allImages["event/event1.webp"],
        allImages["event/event2.webp"],
        allImages["event/event3.webp"],
        allImages["event/event4.webp"],
        allImages["event/event5.webp"],
        allImages["event/event6.webp"],
        allImages["event/event7.webp"],
        allImages["event/event8.webp"],
        allImages["event/event9.webp"],
        allImages["event/event10.webp"],
    ]
  },
  {
    id: 13,
    ...
    category: "Diğer",
    title: "Kişisel",
    image: allImages["gym/gym1.webp"],
    description: "Gücün, hacmin ve formun öne çıktığı sade ve etkili bir bodybuilding çekimi.",
    fullDescription: "Vücut geliştirici sporcu için yapılan çekimde, kas gruplarının hacmini ve definisyonunu net gösteren bir ışık düzeni tercih edildi.",
    client: "Eneshan Fitness",
    year: "2024",
    role: "Event",
    gallery: [
        allImages["gym/gym1.webp"],
        allImages["gym/gym2.webp"],
        allImages["gym/gym3.webp"],
        allImages["gym/gym4.webp"],
        allImages["gym/gym5.webp"],
        allImages["gym/gym6.webp"],
    ]
  },
